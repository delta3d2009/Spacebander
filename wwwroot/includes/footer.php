			...
			<div class='container'>
				...
				<div class='row'>			
					<div class='col-lg-10 col-lg-offset-1'> 
						<p>USE OF THIS SITE SIGNIFIES YOUR AGREEMENT TO THE <br class='hide-desktop'/><a href='terms.php'>TERMS OF USE</a> AND TO OUR <br class='hide-desktop'/><a href='privacy.php'>PRIVACY POLICY.</a></p>
