<?php
	...
	if(isset($_POST["company"]) && isset($_POST["firstname"]) && isset($_POST["lastname"]) && isset($_POST["address"]) && isset($_POST["suite"]) && isset($_POST["city"]) && isset($_POST["state"]) && isset($_POST["zip"]) && isset($_POST["country"]) && isset($_POST["phone"]) && isset($_POST["cell"])  && isset($_POST["email"]) && isset($_POST["fax"]) && isset($_POST["office"]) && isset($_POST["lat"]) && isset($_POST["lng"]) ){
